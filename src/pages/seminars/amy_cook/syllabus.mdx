...
## Rules of Engagement
- Learning to live well, not just academic
- Open and respectful
- Record the sessions
- All beliefs are welcome
- Most of us have a relationship with Mormonism 
- This is a curated group, I am monarch
...
- Reading: Amy Cook, Introduction 

### Week 2
- Date: Monday, 06 March
- Reading: Amy Cook, Chapter 1 "A holy kind of healing"

### Week 3
- Date: Monday, 13 March
- Reading: Amy Cook, Chapter 2 "some striking similarities: personal and philosophical
...
export default ({ children }) => <div className=" w-full mx-auto my-6 prose">{children}</div>; 